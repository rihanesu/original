                    ...
                    <div class="top-page-content row">
                        <div class="left-content col-md-5">
                            <div class="content-introduction mt-5">
                                <h4 class="mb-5">「まっぺん」は各地の特色を投稿する為の</h4>
                                <h4 class="mb-5">サービスです。</h4>
                                <h4 class="mb-5">スポットやグルメなど、あなたの知っている</h4>
                                <h4 class="mb-5">ことを、ぜひ投稿してみて下さい！</h4>
                                <h4 class="mb-5">まずは、他の方の投稿を見てみては</h4>
                                <h4 class="mb-5">いかがでしょうか？</h4>
                            </div>
                        </div>
                                            ...
                                            <section>
                                                <div class="col-md-12 row">
                                                    <a href="{{ action('Admin\PostController@details', ['id' => $post->id]) }}" class="col-md-12">
                                                        @if ($post->image_path)
                                                            <img src="{{ $post->image_path }}" class="col-md-8">
                                                        @else
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="content-about col-md-12 col text-left">
                                                            <br>
                                                            <label>タイトル：{{ Str::limit($post->title, 50) }}</label><br>
                                                            <label>県：{{ $post->prefecture }}</label><br>
                                                            <label>カテゴリー：{{ $post->category }}</label><br>
                                                            <label>本文：{{ Str::limit($post->body, 50) }}</label>
                                                        </div>
                                                    </a>
                                                </div>
                                            </section>
