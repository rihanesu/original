...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="{{ action('Admin\ProfileController@update',$auth->id) }}" method="post" enctype="multipart/form-data">
                @if (count($errors) > 0)
                <ul>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="age" type="text" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $auth->age }}" required autocomplete="age">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="nickname" type="text" class="form-control" name="nickname" value="{{ $auth->nickname }}">
                        @error('nickname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
